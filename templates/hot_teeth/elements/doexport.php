...
if($content) {
	$content = str_replace('hot_teeth', $alias, $content);
	$content = str_replace('HOT_TEETH', $aliasU, $content);
	$content = str_replace('hot_teeth', $nameL, $content);
	$content = str_replace('HOT_TEETH', $nameU, $content);
	$content = str_replace('hot_teeth', $alias, $content);
	$content = str_replace('HOT_TEETH', $aliasU, $content);
	$content = str_replace('hot_teeth', $newname, $content);
	$content = str_replace('hot_teeth', $newname, $content);
	$content = str_replace('hot_teeth', $newname, $content);
