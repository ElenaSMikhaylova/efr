...
class JFormFieldHotfont extends JFormField
{
	...
	protected function getInput()
	{
		...
		$str = file_get_contents(dirname(__FILE__) . DS . ".." . DS . 'js' . DS . 'google-fonts.json');
		...
		<script type="text/javascript">
			...
			?>
				...
				<a class="modal btn system" title="Select" href="#system" rel="{size: {x: 800, y: 500}, onOpen: initializeForSystem}">System Fonts</a>
				
				<a class="modal btn google" title="Select" href="#google" rel="{size: {x: 800, y: 450}, onOpen: initializeForGoogle}">Google Fonts</a>
			</div>
