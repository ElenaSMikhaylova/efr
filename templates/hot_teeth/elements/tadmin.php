...
class JFormFieldTadmin extends JFormField
{
	...
	protected function getInput()
	{
		...
		$document->addStyleSheet(JURI::root(1) . '/templates/'.$TEMPLATE_FOLDER.'/css/bootstrap-multiselect.css');
	    ...
	    //$document->addScript(JURI::root(1) . '/templates/'.$TEMPLATE_FOLDER.'/js/undo_redo.js');
	    $document->addScript(JURI::root(1) . '/templates/'.$TEMPLATE_FOLDER.'/js/bootstrap-multiselect.js');
	    $document->addScript(JURI::root(1) . '/templates/'.$TEMPLATE_FOLDER.'/js/jquery.visible.js');
		...
		*/
		...
		?>
		  <script type="text/javascript" >
		   $ = jQuery;
		   var TADMSCRIPTTRANS = {};
		   TADMSCRIPTTRANS.general    = '<?php echo jText::sprintf('TPL_HOT_TEETH_GENERAL')?>';
		   var TADMIN_JOOMLABASE      = '<?php echo JURI::root(1); ?>';
		   var TADMIN_TEMPLATE_FOLDER = '<?php echo $TEMPLATE_FOLDER; ?>';
		   var TADMIN_LANG = {
				details: '<?php echo JText::sprintf("TPL_HOT_TEETH_DETAILS"); ?>',
				menusassignment: '<?php echo JText::sprintf("TPL_HOT_TEETH_ASIGNMENT"); ?>'
		   };
