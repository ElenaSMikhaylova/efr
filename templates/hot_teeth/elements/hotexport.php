	...
	protected function getInput()
	{
		...
		?>
			...
			<table style="width:300px;height:30px;clear:both;">
				<tr>
					<td>
						<label for="<?php echo $this->id; ?>"><?php echo jText::sprintf("TPL_HOT_TEETH_LABEL_EXPORT") ?></label>
					</td>
					<td>
					...
					<td>
						<button onclick="doExport('<?php echo $jbase; ?>','templates/hot_teeth/elements/doexport.php',jQuery('#<?php echo $this->id; ?>').val());return false;" >Export</button>
					</td>
					<td>
